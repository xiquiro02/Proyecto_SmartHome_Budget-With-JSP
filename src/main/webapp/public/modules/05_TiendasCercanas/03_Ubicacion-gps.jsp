<%@page contentType="text/html" pageEncoding="UTF-8" %>
    ...
    <head>
        ...
        <link rel="stylesheet"
            href="${pageContext.request.contextPath}/asset/css/modules/05_TiendasCercanas/estilosUbicacion-gps.css">
    ...
    <body>
        <main class="contenido">
            <div class="contenedor">
                ...
                <p class="contenido__parrafo">¡Tu ubicación se registró con éxito! Ahora podrás ver tiendas cercanas,
                    ofertas y recomendaciones basadas en tu zona.</p>
