<%@page contentType="text/html" pageEncoding="UTF-8" %>
    ...
    <head>
        ...
        <link rel="stylesheet"
            href="${pageContext.request.contextPath}/asset/css/modules/05_TiendasCercanas/estilosInformacionTienda.css">
    ...
    <body>
        <header class="encabezado">
            ...
            <a href="${pageContext.request.contextPath}/public/modules/05_TiendasCercanas/06_Lista-tiendasCercanas.jsp">
        ...
        <main class="informacionTienda">
            ...
            <div class="informacionBasica">
                <div class="infoItem">
                    <img class="infoItem__icono" src="${pageContext.request.contextPath}/asset/imagenes/etiqueta.png"
                ...
                <div class="infoItem">
                    <img class="infoItem__icono" src="${pageContext.request.contextPath}/asset/imagenes/mapa.png"
                        alt="Icono Información">
                    <div class="infoItem__contenido">
                ...
                <div class="infoItem">
                    <img class="infoItem__icono"
                        src="${pageContext.request.contextPath}/asset/imagenes/viejo-telefono-tipico.png"
                        alt="Icono Información">
                    <div class="infoItem__contenido">
                ...
                <div class="infoItem">
                    <img class="infoItem__icono infoItem__icono--tamano"
                        src="${pageContext.request.contextPath}/asset/imagenes/clock-reloj.png" alt="Icono Información">
                    <div class="infoItem__contenido">
            ...
            <div class="productosDisponibles">
                <div class="productosDisponibles__tituloPrincipal">
                    <img class="productosDisponibles__icono"
                        src="${pageContext.request.contextPath}/asset/imagenes/anadir-al-carrito.png"
                        alt="Icono Información">
            ...
            <a href="${pageContext.request.contextPath}/public/modules/05_TiendasCercanas/06_Lista-tiendasCercanas.jsp"
                class="informacionTienda__boton">
