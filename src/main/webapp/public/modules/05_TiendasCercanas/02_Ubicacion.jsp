<%@page contentType="text/html" pageEncoding="UTF-8" %>
    ...
    <head>
        ...
        <link rel="stylesheet"
            href="${pageContext.request.contextPath}/asset/css/modules/05_TiendasCercanas/estilosUbicacion.css">
    ...
    <body>
        ...
        <main class="contenido">
            <div class="contenedor">
                <img class="contenido__icono-img" src="${pageContext.request.contextPath}/asset/imagenes/ubicacion.png"
                    alt="Icono verificación">
                <h1 class="contenido__titulo">Ubicación </h1>
                <p class="contenido__parrafo"> Para mostrarte tiendas cercanas, ofertas y recomendaciones
                    personalizadas, necesitamos acceder a tu ubicación actual.</p>
                <div class="contenido__grupo">
                    <a href="${pageContext.request.contextPath}/public/modules/05_TiendasCercanas/03_Ubicacion-gps.jsp"
                        class="edicion__botones">
                        <button type="button" class="boton boton--editar">Permitir ubicación</button>
                    </a>
                    <a href="${pageContext.request.contextPath}/public/modules/05_TiendasCercanas/04_UbicacionManualmente.jsp"
                        class="edicion__botones">
