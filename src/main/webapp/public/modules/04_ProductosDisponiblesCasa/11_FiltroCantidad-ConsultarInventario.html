...
<head>
    ...
    <link rel="stylesheet" href="../../../asset/modules/04_ProductosDisponiblesCasa/estilosFiltroCantidad-ConsultarInventario.css">
    ...
    <main class="contenedorInventario">
        ...
        <div class="filtros">
            ...
            <div class="filtro-grupo">
                ...
                <a href="09_ConsultarInventario.html" class="filtro-enlace" alt="Icono filtros">
                    Cantidad
                    <img class="filtro-imagen" src="../../../asset/imagenes/flecha.png" alt="Icono filtros">
                </a>
            </div>
