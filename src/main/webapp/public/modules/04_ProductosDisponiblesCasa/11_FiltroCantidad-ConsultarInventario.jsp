...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/asset/css/modules/04_ProductosDisponiblesCasa/estilosFiltroCantidad-ConsultarInventario.css">
        ...
        <div class="filtroEstado">
            ...
            <label class="filtroEstado__opcion">
                <input type="radio" name="orden" value="menorIgual2" ${ordenSeleccionado == 'menorIgual2' ? 'checked' : ''}
                       onchange="window.location='${pageContext.request.contextPath}/Inventario?accion=filtroCantidad&orden=menorIgual2'">
            ...
            <label class="filtroEstado__opcion">
                <input type="radio" name="orden" value="mayorIgual10" ${ordenSeleccionado == 'mayorIgual10' ? 'checked' : ''}
                       onchange="window.location='${pageContext.request.contextPath}/Inventario?accion=filtroCantidad&orden=mayorIgual10'">
            ...
            <label class="filtroEstado__opcion">
                <input type="radio" name="orden" value="asc" ${ordenSeleccionado == 'asc' ? 'checked' : ''}
                       onchange="window.location='${pageContext.request.contextPath}/Inventario?accion=filtroCantidad&orden=asc'">
            ...
            <label class="filtroEstado__opcion">
                <input type="radio" name="orden" value="desc" ${ordenSeleccionado == 'desc' ? 'checked' : ''}
                       onchange="window.location='${pageContext.request.contextPath}/Inventario?accion=filtroCantidad&orden=desc'">
                <div class="filtroEstado__opcion-contenido"><span class="filtroEstado__opcion-titulo">Ordenar de mayor a menor</span></div>
            </label>
            <a href="${pageContext.request.contextPath}/Inventario?accion=consultar" class="filtroEstado__boton">
