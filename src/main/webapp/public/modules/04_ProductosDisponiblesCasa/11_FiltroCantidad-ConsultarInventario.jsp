<%@page contentType="text/html" pageEncoding="UTF-8" %>
    ...
    <head>
        ...
        <link rel="stylesheet"
            href="${pageContext.request.contextPath}/asset/css/modules/04_ProductosDisponiblesCasa/estilosFiltroCantidad-ConsultarInventario.css">
        ...
        <main class="contenedorInventario">
            ...
            <div class="filtros">
                ...
                <div class="filtro-grupo">
                    <a href="${pageContext.request.contextPath}/public/modules/04_ProductosDisponiblesCasa/10_FiltroCategorias-ConsultarInventario.jsp"
                        class="filtro-enlace">
                        Categoría
            ...
            <div class="panelEstadoFiltro">
                <div class="filtroEstado">
                    <h3 class="filtroEstado__titulo">Seleccionar categoría</h3>
                    <label class="filtroEstado__opcion">
                        <input type="radio" name="estado" checked>
                        <div class="filtroEstado__opcion-contenido">
                            <span class="filtroEstado__opcion-titulo">Menor o igual a 2</span>
                        </div>
                    </label>
                    <label class="filtroEstado__opcion">
                        <input type="radio" name="estado">
                        <div class="filtroEstado__opcion-contenido">
                            <span class="filtroEstado__opcion-titulo">Mayor o igual a 10</span>
                        </div>
                    </label>
                    <label class="filtroEstado__opcion">
                        <input type="radio" name="estado">
                        <div class="filtroEstado__opcion-contenido">
                            <span class="filtroEstado__opcion-titulo">Ordenar de menor a mayor</span>
                        </div>
                    </label>
                    <label class="filtroEstado__opcion">
                        <input type="radio" name="estado">
                        <div class="filtroEstado__opcion-contenido">
                            <span class="filtroEstado__opcion-titulo">Ordenar de mayor a menor</span>
                        </div>
                    </label>
