<%@page contentType="text/html" pageEncoding="UTF-8" %>
    ...
    <head>
        ...
        <link rel="stylesheet"
            href="${pageContext.request.contextPath}/asset/css/modules/04_ProductosDisponiblesCasa/estilosMoverA-Lista.css">
    ...
    <body>
        ...
        <main class="contenedorMover">
            ...
            <a href="${pageContext.request.contextPath}/public/modules/04_ProductosDisponiblesCasa/14_ConfirmacionMovimiento.jsp"
                class="acciones">
