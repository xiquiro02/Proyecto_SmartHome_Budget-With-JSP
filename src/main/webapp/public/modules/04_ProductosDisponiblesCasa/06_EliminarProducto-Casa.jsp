<%@page contentType="text/html" pageEncoding="UTF-8" %>
    ...
    <head>
        ...
        <link rel="stylesheet"
            href="${pageContext.request.contextPath}/asset/css/modules/04_ProductosDisponiblesCasa/estilosEliminarProductoCasa.css">
    ...
    <body>
        <main class="contenido">
            <div class="contenedor">
                ...
                <p class="contenido__parrafo">❗ Esta acción no se puede deshacer. Una vez eliminado, el producto
                    desaparecerá de tu inventario.</p>
                <div class="contenido__grupo">
                    <a
                        href="${pageContext.request.contextPath}/public/modules/04_ProductosDisponiblesCasa/07_ProductoEliminado.jsp">
