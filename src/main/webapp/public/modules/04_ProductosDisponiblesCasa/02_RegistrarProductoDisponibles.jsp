<%@page contentType="text/html" pageEncoding="UTF-8" %>
    ...
    <head>
        ...
        <link rel="stylesheet"
            href="${pageContext.request.contextPath}/asset/css/modules/04_ProductosDisponiblesCasa/estilosRegistrarProductosDisponibles.css">
        ...
        <main class="formulario">
            <div class="formulario__contenedor">
                <div class="formulario__campo">
                    ...
                    <input type="text" id="nombreProducto" class="formulario__input"
                ...
                <div class="formulario__etiquetas">
                    <div class="etiqueta etiqueta--aseo">
                        <img src="${pageContext.request.contextPath}/asset/imagenes/Aseo.png" alt="Icono de Aseo">
                        <span>Aseo</span>
                    </div>
                    ...
                    <div class="etiqueta etiqueta--otros">
                        <img src="${pageContext.request.contextPath}/asset/imagenes/cajas.png" alt="Icono de Otros">
                        <span>Otros</span>
                    </div>
                    <div class="etiqueta etiqueta--ropa-calzado">
                        <img src="${pageContext.request.contextPath}/asset/imagenes/Ropa-calzado.jpg"
                            alt="Icono de Ropa y calzado">
                ...
                <a href="${pageContext.request.contextPath}/public/modules/04_ProductosDisponiblesCasa/03_ConfirmarRegistroProductosDisponibles.jsp"
