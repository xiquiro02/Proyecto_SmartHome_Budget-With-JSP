<%@page contentType="text/html" pageEncoding="UTF-8" %>
    ...
    <head>
        ...
        <link rel="stylesheet"
            href="${pageContext.request.contextPath}/asset/css/modules/04_ProductosDisponiblesCasa/MiInventario.css">
        ...
        <header class="encabezado">
            <div class="encabezado__contenedor">
                <img class="encabezado__imagen"
                    src="${pageContext.request.contextPath}/asset/imagenes/mi-inventario.png"
                    alt="Logo de SmartHome Budget">
                <h1 class="encabezado__titulo">Mi Inventario</h1>
            </div>
            <div class="encabezado__contenido">
                <p class="encabezado__descripcion">Controla tu inventario en casa y actualiza tus listas de compras
                    fácilmente.</p>
            </div>
        ...
        <main class="inventario">
            <div class="inventario__acciones">
                <a href="${pageContext.request.contextPath}/public/modules/04_ProductosDisponiblesCasa/02_RegistrarProductoDisponibles.jsp"
                    class="inventario__opcion">
                    <img class="inventario__opcion-icono"
                        src="${pageContext.request.contextPath}/asset/imagenes/agregar_factura.png" alt="Registrar">
            ...
            <div class="inventario__tarjeta inventario__tarjeta--principal">
                <img class="inventario__tarjeta-icono"
                    src="${pageContext.request.contextPath}/asset/imagenes/mover-archivo.png" alt="Mover">
                ...
                <a href="${pageContext.request.contextPath}/public/modules/04_ProductosDisponiblesCasa/12_ MoverProductosAgotados.jsp"
                    class="inventario__boton">
