<%@page contentType="text/html" pageEncoding="UTF-8" %>
    ...
    <head>
        ...
        <link rel="stylesheet"
            href="${pageContext.request.contextPath}/asset/css/modules/04_ProductosDisponiblesCasa/estilosProductoEliminado.css">
    ...
    <body>
        <main class="contenido">
            <div class="contenedor">
                ...
                <p class="contenido__parrafo"><strong>"Detergente líquido"</strong> fue eliminado del inventario. Tu
                    lista de productos disponibles se ha actualizado correctamente.</p>
