<%@page contentType="text/html" pageEncoding="UTF-8" %>
    ...
    <head>
        ...
        <link rel="stylesheet"
            href="${pageContext.request.contextPath}/asset/css/modules/04_ProductosDisponiblesCasa/estilosConfirmarRegistroProductosDisponibles.css">
    ...
    <body>
        <main class="contenido">
            <div class="contenedor">
                ...
                <h1 class="contenido__titulo">Producto registrado con éxito</h1>
                <p class="contenido__parrafo">El producto ha sido guardado correctamente y añadido a tu inventario
                    doméstico.</p>
                <p class="contenido__parrafo">Recuerda revisar tus productos con frecuencia para mantener tu hogar
                    siempre bien organizado.</p>
                <div class="contenido__grupo">
                    <a href="${pageContext.request.contextPath}/public/modules/04_ProductosDisponiblesCasa/02_RegistrarProductoDisponibles.jsp"
                        ...
                        <button type="button" class="boton boton--editar">Añadir otro producto</button>
                    </a>
