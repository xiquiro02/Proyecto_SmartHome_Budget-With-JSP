    ...
    <% request.setCharacterEncoding("UTF-8"); %>
        <%@ page import="java.net.URLDecoder" %>
            <% String nombre=request.getParameter("nombre"); if (nombre !=null) {
                nombre=URLDecoder.decode(nombre, "UTF-8" ); } else { nombre="Usuario" ; } %>
                <!DOCTYPE html>
                <html lang="es">
                ...
                <head>
                    ...
                    <link rel="stylesheet"
                        href="${pageContext.request.contextPath}/asset/css/modules/01_autenticacion/estilosConfirmacionRegistro.css">
                    ...
                    <main class="contenido">
                        <div class="contenedor">
                            ...
                            <img class="contenido__icono-img"
                                src="${pageContext.request.contextPath}/asset/imagenes/welcome-png.png"
                                alt="Icono verificación">
                            <p class="contenido__parrafo">Ahora puedes gestionar tus facturas, listas de compras y
                                presupuesto
                                desde
                                un solo lugar.</p>
