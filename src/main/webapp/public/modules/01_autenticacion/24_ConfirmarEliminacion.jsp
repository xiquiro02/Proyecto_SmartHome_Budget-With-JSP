<%@page contentType="text/html" pageEncoding="UTF-8" %>
    ...
    <head>
        ...
        <link rel="stylesheet"
            href="${pageContext.request.contextPath}/asset/css/modules/01_autenticacion/estilosConfirmarEliminacion.css">
        ...
        <main class="contenido">
            <div class="contenedor">
                <img class="contenido__icono-img"
                    src="${pageContext.request.contextPath}/asset/imagenes/Eliminacion.png" alt="Icono de Eliminación">
                <h1 class="contenido__titulo">Cuenta eliminada correctamente</h1>
                <p class="contenido__parrafo">Tu cuenta y todos los datos asociados fueron eliminados de forma
                    permanente.</p>
