...
<head>
    ...
    <link rel="stylesheet" href="../../../asset/modules/01_autenticacion/estilosMiPerfil.css">
    <title>SmartHome Budget</title>
</head>
<body>
    <header class="encabezado">
        <a href="../Menu principal/01_menu_principal.html">
    ...
    <main class="contenido">
        <div class="contenedor">
                ...
                <img class="contenido__icono-img" src="../../../asset/imagenes/Icono de perfil de usuario.png" alt="Icono de Perfil">
