<%@page contentType="text/html" pageEncoding="UTF-8" %>
    ...
    <head>
        ...
        <link rel="stylesheet"
            href="${pageContext.request.contextPath}/asset/css/modules/03_ListasCompras/estilosEliminarLista.css">
    ...
    <body>
        <main class="contenido">
            <div class="contenedor">
                ...
                <p class="contenido__parrafo">¿Estás seguro de que deseas eliminar <strong>“Mercado mensual”</strong> ?
                    Esta acción no se puede deshacer.</p>
                <div class="contenido__grupo">
                    <a
                        href="${pageContext.request.contextPath}/public/modules/03_ListasCompras/07_ConfirmarEliminacionLista.jsp">
