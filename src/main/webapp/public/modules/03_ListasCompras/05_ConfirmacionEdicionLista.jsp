<%@page contentType="text/html" pageEncoding="UTF-8" %>
    ...
    <head>
        ...
        <link rel="stylesheet"
            href="${pageContext.request.contextPath}/asset/css/modules/03_ListasCompras/estilosConfirmacionEdicionLista.css">
    ...
    <body>
        <main class="contenido">
            <div class="contenedor">
                ...
                <p class="contenido__parrafo">Los cambios en tu lista se han guardado correctamente.</p>
                <p class="contenido__parrafo">Ahora tu lista <strong>“Mercado mensual”</strong>está actualizada con la
                    información más reciente.</p>
                <div class="contenido__grupo">
                    <a href="${pageContext.request.contextPath}/public/modules/03_ListasCompras/04_EditarListaCompras.jsp"
                        ...
                        <button type="button" class="boton boton--editar">Seguir editando</button>
                    </a>
