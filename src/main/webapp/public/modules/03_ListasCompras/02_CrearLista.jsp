<%@page contentType="text/html" pageEncoding="UTF-8" %>
    ...
    <head>
        ...
        <link rel="stylesheet"
            href="${pageContext.request.contextPath}/asset/css/modules/03_ListasCompras/estilosCrearLista.css">
            ...
            <div class="formulario__contenedor">
                ...
                <div class="formulario__campo">
                    ...
                    <textarea id="descripcion" class="formulario__textarea" rows="4"
                        placeholder="Agrega detalles sobre esta lista..."></textarea>
                </div>
                ...
                <a href="${pageContext.request.contextPath}/public/modules/03_ListasCompras/03_ConfirmarCreacionLista.jsp"
