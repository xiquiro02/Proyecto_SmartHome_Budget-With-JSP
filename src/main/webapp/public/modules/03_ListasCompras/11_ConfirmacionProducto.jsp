<%@page contentType="text/html" pageEncoding="UTF-8" %>
    ...
    <head>
        ...
        <link rel="stylesheet"
            href="${pageContext.request.contextPath}/asset/css/modules/03_ListasCompras/estilosConfirmacionProducto.css">
    ...
    <body>
        <main class="contenido">
            <div class="contenedor">
                ...
                <p class="contenido__parrafo">El producto <strong>“Arroz blanco”</strong> ha sido actualizado en tu
                    lista <strong>“Mercado mensual”</strong>.Los cambios se guardaron exitosamente.</p>
                <div class="contenido__grupo">
                    <a href="${pageContext.request.contextPath}/public/modules/03_ListasCompras/04_EditarListaCompras.jsp"
                        ...
                        <button type="button" class="boton boton--editar">Editar otro producto</button>
                    </a>
