            ...
            <div class="edicion__productos">
                ...
                <div class="producto">
                    ...
                    <div class="producto__botones">
                        <a href="10_EditarProducto.html"><button class="producto__boton producto__boton--editar">✏️ Editar</button></a>
                        <a href="12_EliminarProducto.html"><button class="producto__boton producto__boton--eliminar">🗑️ Eliminar</button></a>
                    </div>
                </div>
