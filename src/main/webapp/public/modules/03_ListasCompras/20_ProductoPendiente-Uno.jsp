<%@page contentType="text/html" pageEncoding="UTF-8" %>
    ...
    <head>
        ...
        <link rel="stylesheet"
            href="${pageContext.request.contextPath}/asset/css/modules/03_ListasCompras/estilosProductoPendiente-Uno.css">
    ...
    <body>
        <main class="contenido">
            <div class="contenedor">
                ...
                <p class="contenido__parrafo">Has marcado <strong>“Tijeras”</strong> como pendiente.</p>
