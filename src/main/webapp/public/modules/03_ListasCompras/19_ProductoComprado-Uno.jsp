...
<head>
    ...
    <link rel="stylesheet" href="../../../asset/modules/03_ListasCompras/estilosProductoComprado-Uno.css">
    <title>SmartHome Budget</title>
</head>
<body>
    <main class="contenido">
        <div class="contenedor">
                <img class="contenido__icono-img" src="../../../asset/imagenes/compra.png" alt="Icono verificación">
                <h1 class="contenido__titulo">Producto marcado como comprado</h1>
                <p class="contenido__parrafo">Has marcado <strong>“Leche”</strong> como comprado.</p>
