<%@page contentType="text/html" pageEncoding="UTF-8" %>
    ...
    <head>
        ...
        <link rel="stylesheet"
            href="${pageContext.request.contextPath}/asset/css/modules/03_ListasCompras/estilosAgregarProductos.css">
    ...
    <body>
        ...
        <main class="formulario">
            <div class="formulario__contenedor">
                ...
                <a href="${pageContext.request.contextPath}/public/modules/03_ListasCompras/09_ConfirmarProducto.jsp"
