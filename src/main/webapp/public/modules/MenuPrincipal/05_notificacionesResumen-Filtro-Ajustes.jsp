<%@page contentType="text/html" pageEncoding="UTF-8" %>
    ...
    <head>
        ...
        <link rel="stylesheet"
            href="${pageContext.request.contextPath}/asset/css/modules/Menuprincipal/estilosNotificacionesResumen-Filtro-Ajustes.css">
        ...
        <main class="notiresumen">
            <div class="notiresumen__filtros">
                <a href="${pageContext.request.contextPath}/public/modules/MenuPrincipal/02_notificacionesResumen-Filtro-Todas.jsp"
                    class="notiresumen__filtro">Todas</a>
            ...
            <a href="${pageContext.request.contextPath}/public/modules/MenuPrincipal/01_menu_principal.jsp"
            ...
            <div class="notiresumen__contenido">
                <div class="notiresumen__opcion">
                    <a href="${pageContext.request.contextPath}/public/modules/MenuPrincipal/06_ajustes.jsp"
                        class="notiresumen__link">
                        <img class="notiresumen__icono"
                            src="${pageContext.request.contextPath}/asset/imagenes/ajustes.png">
