...
<head>
    ...
    <link rel="stylesheet" href="../../../asset/modules/Menu principal/estilosNotificacionesResumen-Filtro-Todas.css">
...
<body>
    ...
    <main class="notiresumen">
        <div class="notiresumen__filtros">
            ...
            <a href="05_notificacionesResumen-Filtro-Ajustes.html" class="notiresumen__filtro notiresumen__filtro--icono">
        ...
        <a href="01_menu_principal.html" class="notiresumen__boton">
