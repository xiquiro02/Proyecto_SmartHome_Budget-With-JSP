<%@page contentType="text/html" pageEncoding="UTF-8" %>
    ...
    <head>
        ...
        <link rel="stylesheet"
            href="${pageContext.request.contextPath}/asset/css/modules/Menuprincipal/estilosNotificacionesResumen-Filtro-Alertas.css">
    ...
    <body>
        ...
        <main class="notiresumen">
            <div class="notiresumen__filtros">
                ...
                <a href="##" class="notiresumen__filtro notiresumen__filtro--activo">Alertas</a>
            ...
            <div class="notiresumen__card notiresumen__card--verde">
                <div class="notiresumen__card-encabezado">
                    ...
                    <div class="notiresumen__texto">
                        <h3 class="notiresumen__titulo">Oferta cercana</h3>
                        <p class="notiresumen__subtitulo">Supermercado XYZ 20% en lácteos</p>
                        <p class="notiresumen__tiempo">Hace 1 semana</p>
                    </div>
                </div>
            </div>
