<%@page contentType="text/html" pageEncoding="UTF-8" %>
    ...
    <head>
        ...
        <link rel="stylesheet"
            href="${pageContext.request.contextPath}/asset/css/modules/02_Gestion_facturas-recordatorios/estilosEditarFactura.css">
    ...
    <body>
        <header class="encabezado">
            ...
            <div class="encabezado__contenedorTitulo">
                <h1 class="encabezado__titulo">Editar Factura</h1>
            </div>
        </header>
        <main class="factura">
            <form class="factura__formulario">
                <div class="factura__grupo">
                    ...
                    <input type="text" class="factura__input" placeholder="Ej: Agua - Acueducto Municipal">
                </div>
                <div class="factura__grupo">
                ...
                <div class="factura__fila">
                    <div class="factura__grupo factura__grupo--medio">
                        ...
                        <input type="text" class="factura__input" placeholder="$ 75.000">
                    </div>
                    <div class="factura__grupo factura__grupo--medio">
                ...
                <a href="${pageContext.request.contextPath}/public/modules/02_Gestion_facturas-recordatorios/08_ConfirmacionEdicion.jsp"
