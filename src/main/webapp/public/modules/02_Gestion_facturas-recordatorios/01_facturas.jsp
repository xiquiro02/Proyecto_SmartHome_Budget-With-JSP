...
<head>
    ...
    <link rel="stylesheet" href="../../../asset/modules/02_Gestion_facturas-recordatorios/estilos-facturas.css">
...
<body>
    <header class="encabezado">
        <div class="encabezado__contenedor">
            <img class="encabezado__imagen" src="../../../asset/imagenes/facturas.png" alt="Logo de SmartHome Budget">
    ...
    <main class="facturas">
        <div class="tarjetaAccion tarjetaAccion--azul">
            <div class="tarjetaAccion__encabezado">
                <img class="tarjetaAccion__icono" src="../../../asset/imagenes/agregar_factura.png" alt="Agregar">
            ...
            <a href="02_formularioRegistrar-facturas.html">
                <button class="boton boton--registrar">Crear</button>
            </a>
        </div>
        <div class="tarjetaAccion tarjetaAccion--verde">
            <div class="tarjetaAccion__encabezado">
                <img class="tarjetaAccion__icono tarjetaAccion__icono--verde" src="../../../asset/imagenes/barra-grafica.png" alt="Consultar">
                <div class="tarjetaAccion__contenido">
            ...
            <a href="03_Consultar-Facturas.html">
                <button class="boton boton--cancelar">Ver todas</button>
            </a>
        </div>
        <div class="tarjetaAccion tarjetaAccion--morado">
            <div class="tarjetaAccion__encabezado">
                <img class="tarjetaAccion__icono tarjetaAccion__icono--morado" src="../../../asset/imagenes/reloj.png" alt="Historial">
                <div class="tarjetaAccion__contenido">
                    <h3 class="tarjetaAccion__titulo">Historial de Pagos</h3>
                    <p class="tarjetaAccion__subtitulo">Facturas ya pagadas</p>
                </div>
            </div>
            <a href="11_HistorialPagos.html"><span class="material-symbols-outlined tarjetaAccion__flecha">arrow_forward</span></a>
        </div>
        <div class="tarjetaAccion tarjetaAccion--gris">
            <div class="tarjetaAccion__encabezado">
                <img class="tarjetaAccion__icono tarjetaAccion__icono--gris" src="../../../asset/imagenes/resumen_rapido.png" alt="Resumen">
        ...
        <a href="../Menu principal/01_menu_principal.html" class="tarjetaAccion__boton">
