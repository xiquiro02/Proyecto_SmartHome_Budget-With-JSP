<%@page contentType="text/html" pageEncoding="UTF-8" %>
    ...
    <head>
        ...
        <link rel="stylesheet"
            href="${pageContext.request.contextPath}/asset/css/modules/06_Finanzas/estilosResumenFinanciero.css">
        ...
        <main class="resumenFinanciero">
            <div class="resumenFinanciero__introduccion">
                <img class="introduccion__icono"
                    src="${pageContext.request.contextPath}/asset/imagenes/estado-financiero.png"
                    ...
                    <div class="resumenCard__contenido">
                        ...
                        <div class="resumenCard__detalles">
                            <a href="${pageContext.request.contextPath}/public/modules/06_Finanzas/04_DetalleIngresos.jsp"
                                class="resumenCard__enlace">👁️ Ver detalles</a>
                        </div>
                    </div>
                </div>
            ...
            <a href="${pageContext.request.contextPath}/public/modules/06_Finanzas/01_Finanzas.jsp"
                class="resumenFinanciero__boton">
