<%@page contentType="text/html" pageEncoding="UTF-8" %>
    ...
    <head>
        ...
        <link rel="stylesheet"
            href="${pageContext.request.contextPath}/asset/css/modules/06_Finanzas/estilosRegistroEgresoExito.css">
    ...
    <body>
        <main class="contenido">
            <div class="contenedor">
                ...
                <p class="contenido__parrafo">Tu gasto fue guardado correctamente y ya se refleja en el total de egresos
                    y en tu balance financiero.</p>
